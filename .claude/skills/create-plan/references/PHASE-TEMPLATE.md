...
- One `/implement` session handles all phases in a group sequentially with full 1M context
- Groups define session boundaries — one session per group
...
- After ALL groups complete, `/implement --audit` reviews the entire implementation
-->

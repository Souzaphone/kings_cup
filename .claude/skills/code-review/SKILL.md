...
allowed-tools: "Read Grep Glob Write Edit Bash(git diff*) Bash(git log*) Bash(git show*) TaskCreate TaskUpdate TaskList TaskGet"
hooks:
  PostToolUse:
    - matcher: "Write"
...
3. **The ONLY reasons to defer** (use sparingly):
